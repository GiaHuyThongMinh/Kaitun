...
if _G.Switch_Hub_Series_R then
	...
	if getgenv().Deleted_Ui then
		...
		if game:GetService("CoreGui"):FindFirstChild('Penguin Hub') then
			game:GetService("CoreGui"):FindFirstChild('Penguin Hub'):Destroy()
		end
		-- Penguin Hub
		local Switch_Hub = Instance.new("ScreenGui")
		Switch_Hub.Name = "Penguin Hub"
		...
		F_Level.Name = "Level"
		F_Level.Parent = game:GetService("CoreGui")["Penguin Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Penguin Hub"].Level
		game:GetService("CoreGui")["Penguin Hub"].Level.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["Penguin Hub"].Level.Fragments.Text = "Penguin Hub"
		game:GetService("CoreGui")["Penguin Hub"].Level.Fragments.Size = UDim2.new(1, 0, 0, 40)
		game:GetService("CoreGui")["Penguin Hub"].Level.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Penguin Hub"].Level.Position = UDim2.new(0.5, 0, -0.2, 0)
		game:GetService("CoreGui")["Penguin Hub"].Level.Fragments.TextStrokeTransparency = 1
		
		-- Time
		local F_Text2 = Instance.new("Frame")
		F_Text2.Name = "Text2"
		F_Text2.Parent = game:GetService("CoreGui")["Penguin Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Penguin Hub"].Text2
		game:GetService("CoreGui")["Penguin Hub"].Text2.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Penguin Hub"].Text2.Fragments.Text = ""
		game:GetService("CoreGui")["Penguin Hub"].Text2.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Penguin Hub"].Text2.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Penguin Hub"].Text2.Position = UDim2.new(0.5, 0, -0.1, 0)
		game:GetService("CoreGui")["PenguinHub"].Text2.Fragments.TextStrokeTransparency = 1
		
		-- Name
		local F_Text = Instance.new("Frame")
		F_Text.Name = "Text"
		F_Text.Parent = game:GetService("CoreGui")["Penguin Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Penguin Hub"].Text
		game:GetService("CoreGui")["Penguin Hub"].Text.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Penguin Hub"].Text.Fragments.Text = '( '..game.Players.LocalPlayer.Name..' )'
		game:GetService("CoreGui")["Penguin Hub"].Text.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Penguin Hub"].Text.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Penguin Hub"].Text.Position = UDim2.new(0.5, 0, 0.14, 0)
		game:GetService("CoreGui")["Penguin Hub"].Text.Fragments.TextStrokeTransparency = 1
		-- Status
		local F_Text3 = Instance.new("Frame")
		F_Text3.Name = "Text3"
		F_Text3.Parent = game:GetService("CoreGui")["Penguin Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Penguin Hub"].Text3
		game:GetService("CoreGui")["Penguin Hub"].Text3.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["Penguin Hub"].Text3.Fragments.Text = 'Status: Farm Level.'
		game:GetService("CoreGui")["Penguin Hub"].Text3.Fragments.Size = UDim2.new(1, 0, 0, 28)
		game:GetService("CoreGui")["Penguin Hub"].Text3.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Pengun Hub"].Text3.Position = UDim2.new(0.5, 0, 0.22, 0)
		game:GetService("CoreGui")["Penguin Hub"].Text3.Fragments.TextStrokeTransparency = 1
		-- Item Sanguine Art
		local F_Text5 = Instance.new("Frame")
		F_Text5.Name = "Text5"
		F_Text5.Parent = game:GetService("CoreGui")["Penguin Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Penguin Hub"].Text5
		game:GetService("CoreGui")["Penguin Hub"].Text5.Fragments.TextColor3 = Color3.fromRGB(245, 245, 245)
		game:GetService("CoreGui")["Penguin Hub"].Text5.Fragments.Text = '...'
		game:GetService("CoreGui")["Penguin Hub"].Text5.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Penguin Hub"].Text5.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Penguin Hub"].Text5.Position = UDim2.new(0.5, 0, 0.38, 0)
		game:GetService("CoreGui")["Penguin Hub"].Text5.Fragments.TextStrokeTransparency = 1
		-- Full Moon
		local F_Text6 = Instance.new("Frame")
		F_Text6.Name = "Text6"
		F_Text6.Parent = game:GetService("CoreGui")["Penguin Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Penguin Hub"].Text6
		game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.TextColor3 = Color3.fromRGB(255,140,0)
		game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.Text = '🌕 75% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
		game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.Size = UDim2.new(1, 0, 0, 25)
		game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Penguin Hub"].Text6.Position = UDim2.new(0.5, 0, -0.03, 0)
		game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.TextStrokeTransparency = 1
		spawn(function()
			while wait(1) do
				pcall(function()
					if Three_World then
						if game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
							game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.Text = '🌕 100% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
							game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.Text = '🌕 75% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
							game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.Text = '🌕 50% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
							game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.Text = '🌕 25% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
							game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.Text = '🌕 15% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						else 
							game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.Text = '🌕 0% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						end 
						...
						game:GetService("CoreGui")["Penguin Hub"].Text2.Fragments.Text = tempo
					else
						game:GetService("CoreGui")["Penguin Hub"].Text6.Fragments.Text = '🌕 0% ('..tostring(game:GetService("Lighting").TimeOfDay)..')'
						local scripttime=game.Workspace.DistributedGameTime
						local seconds = scripttime%60
		...
		F_Text4.Name = "Text4"
		F_Text4.Parent = game:GetService("CoreGui")["Penguin Hub"]
		...
		game:GetService("Players").LocalPlayer.PlayerGui.Main.Fragments:Clone().Parent = game:GetService("CoreGui")["Penguin Hub"].Text4
		game:GetService("CoreGui")["Penguin Hub"].Text4.Fragments.TextColor3 = Color3.fromRGB(0, 255, 186) 
		game:GetService("CoreGui")["Prnguin Hub"].Text4.Fragments.Text = '...'
		game:GetService("CoreGui")["Penguin Hub"].Text4.Fragments.Size = UDim2.new(1, 0, 0, 35)
		game:GetService("CoreGui")["Penguin Hub"].Text4.Fragments.TextXAlignment = 'Center'
		game:GetService("CoreGui")["Penguin Hub"].Text4.Position = UDim2.new(0.5, 0, 0.47, 0)
		game:GetService("CoreGui")["Penguin Hub"].Text4.Fragments.TextStrokeTransparency = 1
		...
		game:GetService("UserInputService").InputBegan:Connect(function(input, isTyping)
			if not isTyping then
				if input.KeyCode == Enum.KeyCode.B then
					if togle_up then
						game:GetService("CoreGui")["Penguin Hub"].Enabled = false
						game.Lighting.ExposureCompensation = 0
						--BlurSwitch.Size = 0
						togle_up = false
					else
						game:GetService("CoreGui")["Penguin Hub"].Enabled = true
		...
		ToggleImgUi.Image = "rbxassetid://71559742701570"
		...
		Uitoggle.Text = "Penguin Hub Kaitun"
		...
		Yedhee.Text = "Black screen"
		Yedhee.TextColor3 = Color3.fromRGB(0, 255, 186) 
		Yedhee.TextSize = 12.000
		
		if game.CoreGui:FindFirstChild('Penguin Hub C') then
			game.CoreGui:FindFirstChild('Penguin Hub C'):Destroy()
		end
		local function click(a)
			...
			repeat 
				for i,v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.InventoryContainer.Right.Content.ScrollingFrame.Frame:GetDescendants()) do
					if v.Name == 'Background' and tostring(v.BackgroundColor) == 'Bright red' and not table.find(keep_all_name,v.Parent.ItemName.Text) then 
						v.Parent:Clone().Parent = game:GetService("CoreGui")["Penguin Hub C"][Folder]
						game:GetService("CoreGui")["Penguin Hub C"][Folder][v.Parent.Name].Name = v.Parent.ItemName.Text
	...
	function SendFullMoon(vux)
		...
		local R = {Url = "https://discord.com/api/webhooks/1293912461774159902/NUzNQjQ66Yhjrox5vvAeQfkblWH1-Gj7bwW62ToSgwRCWTRw6Y65Dt9c0e7pxbASyywc", Body = newdata, Method = "POST", Headers = headers}
		request(R)
	end
